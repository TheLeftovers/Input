...
-- Started on 2015-12-02 13:22:14
...
--
-- TOC entry 2016 (class 0 OID 16505)
-- Dependencies: 172
...
SELECT pg_catalog.setval('connections_conn_id_seq', 22517, true);


--
-- TOC entry 2017 (class 0 OID 16511)
-- Dependencies: 173
...
SELECT pg_catalog.setval('events_event_id_seq', 15136, true);


--
-- TOC entry 2018 (class 0 OID 16523)
-- Dependencies: 174
...
--
-- TOC entry 2019 (class 0 OID 16529)
-- Dependencies: 175
...
--
-- TOC entry 1906 (class 2606 OID 16688)
-- Name: positions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY positions
    ADD CONSTRAINT positions_pkey PRIMARY KEY (unit_id, rd_x, rd_y, date, "time", course, speed);
...
-- Completed on 2015-12-02 13:22:15
